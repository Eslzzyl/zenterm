...
const TABLE: &[Entry] = &[
    ...
    Entry {
        key: Key::ArrowLeft,
        code: 1,
        terminator: Terminator::Letter(b'D'),
    },
    Entry {
        key: Key::ArrowRight,
        code: 1,
        terminator: Terminator::Letter(b'C'),
    },
    Entry {
        key: Key::ArrowUp,
        code: 1,
        terminator: Terminator::Letter(b'A'),
    },
    Entry {
        key: Key::ArrowDown,
        code: 1,
        terminator: Terminator::Letter(b'B'),
    },
    // ── Navigation ──────────────────────────────────────────────────
    Entry {
        key: Key::PageUp,
    ...
    Entry {
        key: Key::Home,
        code: 1,
        terminator: Terminator::Letter(b'H'),
    },
    Entry {
        key: Key::End,
        code: 1,
        terminator: Terminator::Letter(b'F'),
    },
    // ── Function keys ───────────────────────────────────────────────
    Entry {
        key: Key::F1,
        code: 1,
        terminator: Terminator::Letter(b'P'),
    },
    Entry {
        key: Key::F2,
        code: 1,
        terminator: Terminator::Letter(b'Q'),
    },
    Entry {
        key: Key::F3,
        code: 13,
    ...
    Entry {
        key: Key::F4,
        code: 1,
        terminator: Terminator::Letter(b'S'),
    },
    Entry {
        key: Key::F5,
        code: 15,
